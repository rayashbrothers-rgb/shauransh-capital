      ...
      <div className="flex items-center gap-8">
        ...
        <div className="flex items-center gap-6">
          ...
          <a 
            href="/" 
            target="_blank"
            className="flex items-center gap-2 group px-4 py-2 border border-white/10 hover:border-brand-gold/40 rounded-lg text-xs font-bold uppercase tracking-widest text-white/70 hover:text-white transition-all"
          >
            Live Site
